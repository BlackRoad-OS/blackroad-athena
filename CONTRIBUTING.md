# Contributing to blackroad-athena
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-athena.git
cd blackroad-athena

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-athena.git
